    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".tombol-print", function() {
        	...
        	if (startDate == '') {
                ...
                if (id == 'print-pdf') {
                    window.open('realisasi-penerimaan-pdf/' + encodeURIComponent(kecamatan) + '/' + startDate + '/' + endDate + '/pdf', '_blank');
                } else {
                    window.open('realisasi-penerimaan-excel/' + encodeURIComponent(kecamatan) + '/' + startDate + '/' + endDate + '/excel', '_blank');
                }
